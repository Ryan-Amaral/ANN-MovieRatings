...
public:
	...
	static const int BASIC_CRITERIA_AMOUNT = 8; // the amount of criteria used if basic
	static const int COMPLEX_CRITERIA_AMOUNT = 25; // the amount of criteria used if not basic
	double ErrorRate;
};
